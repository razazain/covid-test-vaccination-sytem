                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $query = "SELECT * FROM `hospital_login` WHERE CONCAT (`hospital_id`,`hospital_name`,`hospital_address`,`hospital_num`) LIKE '%" . $valueToSearch . "%'";
                                $search_result = filterTable($query);
                            } else {
                                $query = "SELECT * FROM `hospital_login`";
                                $search_result = filterTable($query);
                            }
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['hospital_num']; ?></td>
                    ...
                    <td>
                        <div class='dropdown dropdown-action'>
                            ...
                            <a class='dropdown-item' href='edit_hospital_detail.php?hid=$row[hospital_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                            <a class='dropdown-item' href='delete_hospital_detail.php?hid=$row[hospital_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
