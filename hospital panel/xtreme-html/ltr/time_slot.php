        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Timeslots</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Timeslots</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Vaccine Time SLots</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    //show code
                                    $sql_query = "select v.vaccine_time_id, v.datetime, d.vaccine_name from vaccine_timeslot v 
                                    inner join vaccine_details d on v.vaccine_id=d.vaccine_id";
                                    ...
                                    while ($data = mysqli_fetch_assoc($result)) {
                                                                                echo "
                                        <tr>
                                        <td>" . $data['vaccine_time_id'] . "</td>
                                        <td>" . $data['vaccine_name'] . "</td>
                                        <td>" . $data['datetime'] . "</td>
                                        <td><div class='dropdown dropdown-action'>
                                                    <a href='#' class='action-icon dropdown-toggle' data-toggle='dropdown' aria-expanded='false'><i class='fa fa-ellipsis-v'></i></a>
                                                    <div class='dropdown-menu dropdown-menu-right'>
                                                        <a class='dropdown-item' href='edit_vaccine_time_slot.php?tid=$data[vaccine_time_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                                                        <a class='dropdown-item' href='delete_vaccine_time_slot.php?tid=$data[vaccine_time_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                                                    </div>
                                                </div></td>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Covid Test Time Slots</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    //show code
                                    $sql_query = "select c.time_id, c.datetime, t.c_name from covid_test_timeslot c 
                                    inner join covid_test_type t on c.c_id=t.c_id";
                                    $result = mysqli_query($conn, $sql_query) or die(mysqli_error($conn));
                                    ...
                                    while ($data = mysqli_fetch_assoc($result)) {
                                        ...
                                        <td><div class='dropdown dropdown-action'>
                                                    <a href='#' class='action-icon dropdown-toggle' data-toggle='dropdown' aria-expanded='false'><i class='fa fa-ellipsis-v'></i></a>
                                                    <div class='dropdown-menu dropdown-menu-right'>
                                                        <a class='dropdown-item' href='edit_covid_time_slot.php?cid=$data[time_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                                                        <a class='dropdown-item' href='delete_covid_time_slot.php?cid=$data[time_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                                                    </div>
                                                </div></td>
