...
$id = $_REQUEST['cid'];
$query = "SELECT * from covid_test_request where request_id='" . $id . "'";
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['add_rec'])) {
                                        ...
                                        $query = "insert into covid_test_report (r_name,r_address,r_city,r_number,r_test,r_time,r_report) 
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="test" placeholder="Enter number" required value="<?php echo $data['test_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="time" placeholder="Enter number" required value="<?php echo $data['test_time']; ?>" /></p>
