...
$id = $_REQUEST['vid'];
$query = "SELECT * from vaccine_details where vaccine_id ='" . $id . "'";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Vaccine Details</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Vaccine Details</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        $id  = $_REQUEST['vid'];
                                        $name = $_REQUEST['name'];
                                        $availabilty = $_REQUEST['availabilty'];





                                        $query = "UPDATE vaccine_details SET vaccine_name='$name',vaccine_availabilty='$availabilty' WHERE vaccine_id='$id' ";
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Vaccine Name" required value="<?php echo $data['vaccine_name']; ?>" /></p>



                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="availabilty" value="AVAILABLE">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="availabilty" value="NOT AVAILABLE">
                                                    <label class="form-check-label" for="exampleRadios1">
                                                        Not Available
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <input type="submit" class="btn btn-danger btn-block btn-lg gradient-custom-4 text-white" value="UPDATE" name="submit">
                                                </div>
                                            </form>
