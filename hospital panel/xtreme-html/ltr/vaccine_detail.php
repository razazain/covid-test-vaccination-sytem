                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $query = "SELECT * FROM `vaccine_details` WHERE CONCAT (`vaccine_id`,`vaccine_name`,`vaccine_availabilty`) LIKE '%" . $valueToSearch . "%'";
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['vaccine_availabilty']; ?></td>
                                                    <?php
                                                    ...
                                                    echo "
                                                        ...
                                                        <a class='dropdown-item' href='edit_vaccine_detail.php?vid=$row[vaccine_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                                                        <a class='dropdown-item' href='delete_vaccine_detail.php?vid=$row[vaccine_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                                                        </div>
                                                        </div></td>
                            </tr>
                            " ?>
