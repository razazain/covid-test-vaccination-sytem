        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">POST VACCINATION TIMESLOT</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="post_vacccine_timeslot.php">Post Vaccination TimeSlot</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Post Vaccination TimeSlot</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" class="form-signin">
                                    ...
                                    <div class="form-group">
                                        <label>Enter Time Slot</label>
                                        <input type="datetime-local" name="datetime" required class="form-control">
                                    </div>

                                    <div class="form-group text-center">
                                        <input name="add_rec" value="POST" class="btn btn-primary account-btn" type="submit">
                                    </div>
                            ...
                            if (isset($_POST['add_rec'])) {
                                $vaccine_id = mysqli_real_escape_string($conn, $_POST['vaccine_details']);
                                $datetime = $_POST['datetime'];


                                $sql_query = "insert into vaccine_timeslot (datetime,vaccine_id) values ('$datetime','$vaccine_id')";
                                $result = mysqli_query($conn, $sql_query) or die(mysqli_error($conn));

                                if ($result) {
                                    
                                        echo '<script>alert("Successfullly Posted")</script>';
