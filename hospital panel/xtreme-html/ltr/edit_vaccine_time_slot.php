                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE vaccine_timeslot SET datetime='$datetime' WHERE vaccine_time_id='$id' ";
...
<form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" readonly value="<?php echo $data['vaccine_name']; ?>" /></p>
                                                <p><input class="form-control" type="datetime-local" name="datetime" placeholder="Enter date & time "required value="<?php echo $data['datetime']; ?>" /></p>
