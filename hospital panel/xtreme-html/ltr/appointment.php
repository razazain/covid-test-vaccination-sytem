            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        $query = "SELECT * FROM `covid_test_request` WHERE CONCAT (`request_id`,`patient_name`,`patient_address`,`patient_city`,`patient_num`,`test_name`,`test_time`) LIKE '%" . $valueToSearch . "%'";
                                        $search_result = filterTable($query);
                                    } else {
                                        $query = "SELECT * FROM `covid_test_request`";
                                        $search_result = filterTable($query);
                                    }
                        ...
                        <a class='dropdown-item' href='covid_report.php?cid=$row[request_id]'><i class='fa fa-pencil m-r-5'></i> Go To Report</a>
                            <a class='dropdown-item' href='edit_covid_appointment_detail.php?cid=$row[request_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                            <a class='dropdown-item' href='delete_covid_appointment_detail.php?cid=$row[request_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                        </div>
                    </div></td>
                            </tr>
                            " ?>
