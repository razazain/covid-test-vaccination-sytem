        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Covid Test Report</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Covid Test Report</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Covid Test Report</h4>
                            </div>
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $query = "SELECT * FROM `covid_test_report` WHERE CONCAT (`test_id`,`r_name`,`r_address`,`r_city`,`r_number`,`r_test`,`r_time`,`r_report`) LIKE '%" . $valueToSearch . "%'";
                                $search_result = filterTable($query);
                            } else {
                                $query = "SELECT * FROM `covid_test_report`";
                                $search_result = filterTable($query);
                            }
                                                        ...
                                                        <td>
                                                            <div class='dropdown dropdown-action'>
                                                                ...
                                                                <div class='dropdown-menu dropdown-menu-right'>
                                                                    <a class='dropdown-item' href='edit_covid_test_report.php?pid=$row[test_id]'><i class='fa fa-pencil m-r-5'></i>Edit</a>
                                                                    <a class='dropdown-item' href='delete_covid_test_report.php?pid=$row[test_id]'><i class='fa fa-trash-o m-r-5'></i>Delete</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
