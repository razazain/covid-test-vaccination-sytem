            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Vaccine appointments</h4>
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        $query = "SELECT * FROM `vaccine_request` WHERE CONCAT (`request_id`,`patient_name`,`patient_address`,`patient_city`,`patient_num`,`vaccine_name`,`vaccine_time_slot`) LIKE '%" . $valueToSearch . "%'";
                                        $search_result = filterTable($query);
                                    } else {
                                        $query = "SELECT * FROM `vaccine_request`";
                                        $search_result = filterTable($query);
                                    }
                                                ...
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['vaccine_time_slot']; ?></td>
                                                            ...
                                                            <a class='dropdown-item' href='vaccine_test_report.php?vid=$row[request_id]'><i class='fa fa-pencil m-r-5'></i> Go To Report</a>
                                                                <a class='dropdown-item' href='edit_vaccine_appointment_detail.php?vid=$row[request_id]'><i class='fa fa-pencil m-r-5'></i> Edit</a>
                                                                <a class='dropdown-item' href='delete_vaccine_appointment_detail.php?vid=$row[request_id]'><i class='fa fa-trash-o m-r-5'></i> Delete</a>
                                                            </div>
                                                        </div></td>
</tr>
" ?>
