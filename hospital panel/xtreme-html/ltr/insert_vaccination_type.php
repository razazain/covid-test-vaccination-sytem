            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">INSERT VACCINE TYPE</h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['add_rec'])) {
                                        ...
                                        $query = "INSERT INTO `vaccine_details` ( `vaccine_name`, `vaccine_availabilty`) VALUES ( '$name', '$availabilty');";
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Vaccine Name" required /></p>
