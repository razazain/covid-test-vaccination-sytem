...
$id = $_REQUEST['vid'];
$query = "SELECT * from vaccine_request where request_id='" . $id . "'";
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['add_rec'])) {
                                        ...
                                        $query = "insert into vaccination_report (t_name,t_address,t_city,t_number,t_test,t_time,t_report) 
                                        values ('$name','$address','$city','$number','$test','$time','$report') ";
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" readonly value="<?php echo $data['patient_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="address" placeholder="Enter address" readonly value="<?php echo $data['patient_address']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="city" placeholder="Enter city" readonly value="<?php echo $data['patient_city']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="number" placeholder="Enter number" readonly value="<?php echo $data['patient_num']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="test" placeholder="Enter number" readonly value="<?php echo $data['vaccine_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="time" placeholder="Enter number" readonly value="<?php echo $data['vaccine_time_slot']; ?>" /></p>

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="report" value="VACCINATED">
                                                ...
                                                <p><input class="btn btn-danger btn-block btn-lg gradient-custom-4 text-body" name="add_rec" type="submit" value="SUBMIT" /></p>
                                            </form>
