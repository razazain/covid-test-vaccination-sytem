                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">POST TIME SLOTS</h4>
                                        <h5 class="card-subtitle">Covid Test Timeslots & Vaccination Timeslots</h5>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                <thead>
                                                    ...
                                                    <th>Covid Test Timeslot</th>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><a href="post_vacccine_timeslot.php" class="btn btn-primary account-btn">POST TIMESLOT</a></td>
                                                        <td><a href="post_covid_test_timeslot.php" class="btn btn-primary account-btn">POST TIMESLOT</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">Vaccination Type & Covid Test Type</h5>
                                    </div>
                                    <div class="ms-auto d-flex no-block align-items-center">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                <thead>
                                                    <th>Insert vaccination Type</th>
                                                    <th>Insert Covid Test Type</th>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><a href="insert_vaccination_type.php" class="btn btn-primary account-btn">INSERT</a></td>
                                                        <td><a href="insert_covid_test_type.php" class="btn btn-primary account-btn">INSERT</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
