        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">POST COVID TEST TIMESLOT</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="post_vacccine_timeslot.php">Post Covid test TimeSlot</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Post Covid test TimeSlot</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data" class="form-signin">
                                    ...
                                    <label>Select Covid Test Type</label>
                                    <select name="covid_test_type">
                                        <?php
                                        $sql = "SELECT * FROM covid_test_type";
                            ...
                            if (isset($_POST['add_rec'])) {
                                $c_id  = mysqli_real_escape_string($conn, $_POST['covid_test_type']);
                                $datetime = $_POST['datetime'];


                                $sql_query = "insert into covid_test_timeslot (datetime,c_id) values ('$datetime','$c_id')";
