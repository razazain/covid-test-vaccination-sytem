        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Insert Covid Test Type</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Insert Covid Test Type</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">INSERT COVID TEST TYPE</h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['add_rec'])) {
                                        ...
                                        $query = "INSERT INTO `covid_test_type` ( `c_name`, `c_available`) VALUES ( '$name', '$availabilty');";
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Covid Test Name" required /></p>



                                                <div class="form-check">
                                                    <input class="form-check-input" required type="radio" name="availabilty" value="AVAILABLE">
                                                ...
                                                <div class="form-check"> 
                                                    <input class="form-check-input" required type="radio" name="availabilty" value="NOT AVAILABLE">
                                                    <label class="form-check-label" for="exampleRadios1">
                                                        Not Available
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <input type="submit" class="btn btn-danger btn-block btn-lg gradient-custom-4 text-white" value="ADD" name="add_rec">
                                                </div>
                                            </form>
