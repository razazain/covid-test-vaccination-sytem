            ...
            <div class="card">
              <div class="card-body">
                <center class="m-t-30"> <img src="./img_rec/<?php echo $row['patient_img']; ?>" class="rounded-circle" width="150" />
                  ...
                  <h6 class="card-subtitle"><a href="change_profile_image.php">Change Profile Picture</a></h6>
            ...
            <div class="card">
              <div class="card-body">
                ...
                if (isset($_POST['update'])) {
                  ...
                  $query = "UPDATE patient_detail SET patient_name='$name',patient_email='$email',patient_password='$password',patient_num='$number',
                  patient_address='$address',patient_age='$age',patient_city='$city' WHERE patient_id  = '" . $_SESSION['usp'] . "'";
                ...
                ?>
                  ...
                  <form method="post" enctype="multipart/form-data" class="form-horizontal form-material mx-2">
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" name="name" value="<?php echo $row['patient_name']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">Address</label>
                      <div class="col-md-12">
                        <input type="text" name="address" value="<?php echo $row['patient_address']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="exhmple-email" class="col-md-12">Email</label>
                      <div class="col-md-12">
                        <input type="email" name="email" value="<?php echo $row['patient_email']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-12">Password</label>
                      <div class="col-md-12">
                        <input type="password" name="password" value="<?php echo $row['patient_password']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-12">Phone No</label>
                      <div class="col-md-12">
                        <input type="text" name="number" value="<?php echo $row['patient_num']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-12">City</label>
                      <div class="col-md-12">
                        <input type="text" name="city" value="<?php echo $row['patient_city']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-12">Age</label>
                      <div class="col-md-12">
                        <input type="text" name="age" value="<?php echo $row['patient_age']; ?>" class="form-control form-control-line">
                      </div>
                    </div>
                    <div class="form-group">
