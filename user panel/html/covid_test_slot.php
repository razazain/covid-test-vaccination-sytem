            ...
            <div class="container text-center wow fadeInUp">
                <nav aria-label="Breadcrumb">
                    <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Covid Test Slot</li>
                    </ol>
                </nav>
                <h1 class="font-weight-normal">COVID TEST SLOT</h1>
            </div> <!-- .container -->
        </div> <!-- .banner-section -->
    </div> <!-- .page-banner -->
                        ...
                        <?php while ($data = mysqli_fetch_assoc($result)) {
                              ...
                              <td><div class='dropdown dropdown-action'>
                                          ...
                                          <div class='dropdown-menu dropdown-menu-right'>
                                              <a class='dropdown-item' href='book_covid_test_slot.php?zid=$data[time_id]'>BOOK THE SLOT</a>
                                          </div>
                                      </div></td>
