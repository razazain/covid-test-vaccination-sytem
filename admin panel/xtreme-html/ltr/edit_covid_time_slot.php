                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE covid_test_timeslot SET datetime='$datetime' WHERE time_id='$id' ";
                                    ...
                                    ?>
                                            ...
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" readonly value="<?php echo $data['c_name']; ?>" /></p>
