...
$id= $_REQUEST['pid'];
$query = "SELECT * from vaccination_report where t_id='" . $id . "'";
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE vaccination_report SET t_name='$name',t_address='$address',t_city='$city',t_number='$number',t_test='$test',t_time='$time',t_report='$report' WHERE t_id='$id' ";
...
<form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" required value="<?php echo $data['t_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="address" placeholder="Enter address"required value="<?php echo $data['t_address']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="city" placeholder="Enter city" required value="<?php echo $data['t_city']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="number" placeholder="Enter number" required value="<?php echo $data['t_number']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="test" placeholder="Enter Test name" required value="<?php echo $data['t_test']; ?>"/></p>
                                                <p><input class="form-control" type="date-local" name="time" placeholder="Enter time" required value="<?php echo $data['t_time']; ?>"/></p>
                                                
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="report" value="VACCCINATED">
