...
$id= $_REQUEST['tid'];
$query = "SELECT * from covid_test_type where c_id ='" . $id . "'";
                            ...
                            <div class="table-responsive">
                                ...
                                <?php
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE covid_test_type SET c_name='$name',c_available='$availabilty' WHERE c_id='$id' ";
                                    ...
                                    ?>
                                        ...
                                        <div class="card-body">
                                            <form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Covid Test Type Name" readonly value="<?php echo $data['c_name']; ?>" /></p>
