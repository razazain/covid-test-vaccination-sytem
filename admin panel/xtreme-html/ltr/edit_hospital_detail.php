...
$id= $_REQUEST['hid'];
$query = "SELECT * from hospital_login where hospital_id ='" . $id . "'";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Hospital Details</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <?php
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE hospital_login SET hospital_name='$name',hospital_address='$address',hospital_num='$number',hospital_email='$email',hospital_password='$password'  WHERE hospital_id ='$id' ";
...
<form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" required value="<?php echo $data['hospital_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="address" placeholder="Enter address"required value="<?php echo $data['hospital_address']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="number" placeholder="Enter number" required value="<?php echo $data['hospital_num']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="email" placeholder="Enter Email" required value="<?php echo $data['hospital_email']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="password" placeholder="Enter Password" required value="<?php echo $data['hospital_password']; ?>"/></p>
