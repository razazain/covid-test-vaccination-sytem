            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="./img_rec/<?php echo $row['admin_img']; ?>" class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo $row['admin_name']; ?></h4>
                                    <h6 class="card-subtitle"><?php echo $row['admin_designation']; ?></h6>
                            ...
                            <div class="card-body">
                                ...
                                <h6><?php echo $row['admin_number']; ?></h6>
                                <div class="map-box">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if (isset($_POST['update'])) {
                                    ...
                                    $query = "UPDATE admin_login SET username='$user',admin_name='$name',admin_email='$email',password='$password',admin_number='$number',admin_designation='$designation' WHERE admin_id = '" . $_SESSION['amp'] . "'";
                                ...
                                ?>
                                    ...
                                    <form method="post" enctype="multipart/form-data" class="form-horizontal form-material mx-2">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="name" value="<?php echo $row['admin_name']; ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">Username</label>
                                            <div class="col-md-12">
                                                <input type="text" name="user" value="<?php echo $row['username']; ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email" class="col-md-12">Email</label>
                                            <div class="col-md-12">
                                                <input type="email" name="email" value="<?php echo $row['admin_email']; ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" name="number" value="<?php echo $row['admin_number']; ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-12">Designation</label>
                                            <div class="col-md-12">
                                                <input type="text" name="designation" value="<?php echo $row['admin_designation']; ?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        <div class="form-group">
