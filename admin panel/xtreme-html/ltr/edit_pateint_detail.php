...
$id= $_REQUEST['pid'];
$query = "SELECT * from patient_detail where patient_id ='" . $id . "'";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Pateint Details</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="pages-profile.php">Pateint Details</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Pateint Details</h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    if (isset($_POST['new']) && $_POST['new'] == 1) {
                                        ...
                                        $query = "UPDATE patient_detail SET patient_name='$name',patient_address='$address',patient_city='$city',patient_num='$number',patient_email='$email',patient_age='$age' WHERE patient_id='$id' ";
...
<form name="form" method="post" enctype="multipart/form-data">
                                                ...
                                                <p><input class="form-control" type="text" name="name" placeholder="Enter Name" required value="<?php echo $data['patient_name']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="address" placeholder="Enter address"required value="<?php echo $data['patient_address']; ?>" /></p>
                                                <p><input class="form-control" type="text" name="city" placeholder="Enter city" required value="<?php echo $data['patient_city']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="number" placeholder="Enter number" required value="<?php echo $data['patient_num']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="email" placeholder="Enter email" required value="<?php echo $data['patient_email']; ?>"/></p>
                                                <p><input class="form-control" type="text" name="age" placeholder="Enter Age" required value="<?php echo $data['patient_age']; ?>"/></p>
                        ...
                        <!-- <td> <a class='btn btn-danger btn-block gradient-custom-4 text-body' href='student_edit_rec.php?id= $data[student_id]'>EDIT</a>  </td>
            <td> <a class='btn btn-danger btn-block gradient-custom-4 text-body' href='student_delete_rec.php?id= $data[student_id]'>DELETE</a>  </td> -->
