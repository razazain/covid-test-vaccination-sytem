                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($search_result)) : ?>
                                                    <tr>
                                                        ...
                                                        <?php
                                                        echo "
                                                        <td> <img src='../../../user panel/html/img_rec/$row[patient_img]' width='100px' height='100px'> </td>                 
                                                        ...
                                                        <td>
                                                            <div class='dropdown dropdown-action'>
                                                                ...
                                                                <div class='dropdown-menu dropdown-menu-right'>
                                                                    ...
                                                                    <a class='dropdown-item' href='change_pateint_image.php?pid=$row[patient_id]'><i class='fa fa-pencil m-r-5'></i>Change Image</a>
